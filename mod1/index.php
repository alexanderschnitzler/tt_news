...
class tx_ttnews_module1 extends \TYPO3\CMS\Backend\Module\BaseScriptClass
{
    ...
    public $selectedCategories;    // list of selected category from GETvars extended by subcategories
    ...
    public $localCalcPerms = 0; // CALC_PERMS for the current page. Used for the module header.
    public $grspCalcPerms = 0; // CALC_PERMS for the "general record storage page". Used for categories.
    public $newArticleCalcPerms = 0; // CALC_PERMS for the page with news articles (newArticlePid).
...
//        }
     ...
     * @return    [type]        ...
     */
    public function getListHeaderMsg(&$dblist)
    {
        global $LANG;
...
//            $reset = '<a href="'.$this->script.'?id='.$this->id.'" id="resetcatselection">'.$LANG->getLL('resetCatSelection').'</a>';
    ...
    public function displaySearch($url)
    {
